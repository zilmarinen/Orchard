...
public class EdificeInspector: InspectorGridView {
    ...
    private let viewModel: EdificeInspectorViewModel
    
    public required init(viewModel: EdificeInspectorViewModel) {
        
        self.viewModel = viewModel
        
        super.init(title: "Architecture",

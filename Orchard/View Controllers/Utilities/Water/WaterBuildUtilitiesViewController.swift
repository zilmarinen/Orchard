        ...
        case .build(let editor, let tool):
            ...
            case .scene(let world):
                ...
                case .down(let start, let inputType):
                    ...
                    guard let terrainNode = world.terrain.find(node: start.coordinate) else { return }
                    ...
                    case .left:
                        ...
                        case .edge:
                            ...
                            let waterNodeEdge = world.water.add(edge: start.coordinate, edge: start.edge, waterType: tool.waterType)
                    ...
                    case .right:
                        ...
                        guard let waterNode = world.water.find(node: start.coordinate) else { break }
                        ...
                        case .edge:
                            ...
                            world.water.remove(edge: waterNodeEdge)
                            
                        case .tile:
                            
                            world.water.remove(node: waterNode)
                        }
                ...
                case .tracking(_, let end, _, _):
                    ...
                    guard let terrainNode = world.terrain.find(node: end.coordinate), let colorPalette = tool.waterType.colorPalette else { break }

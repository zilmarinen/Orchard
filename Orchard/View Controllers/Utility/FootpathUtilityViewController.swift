...
class FootpathUtilityViewController: NSViewController {
    ...
    @IBAction func popUp(_ sender: NSPopUpButton) {
        ...
        case utilityTypePopUp:
            ...
            guard let utility = FootpathUtilityCoordinator.Utility(rawValue: sender.indexOfSelectedItem) else { return }
        ...
        case buildToolTypePopUp,
            ...
            guard let toolType = FootpathUtilityCoordinator.ToolType(rawValue: sender.indexOfSelectedItem) else { return }
        ...
        case buildTypePopUp,
            ...
            guard let footpathType = FootpathType(rawValue: sender.indexOfSelectedItem) else { return }
            
            coordinator?.viewModel.set(footpathType: footpathType)
